const zh = {
    ...
    export: '导出',
    clearAll: '清空全部',
    searchHistory: '搜索翻译历史',
    sourceLanguage: '源语言',
    targetLanguage: '目标语言',
    refresh: '刷新',
    totalTranslations: '总翻译次数',
    todayTranslations: '今日翻译次数',
    languagesUsed: '使用语言数',
    ...
    actions: '操作',
    use: '使用',
    translationDetail: '翻译详情',
    cancel: '取消',
    noHistoryToExport: '没有历史记录可以导出',
    exportSuccess: '导出成功',
    clearAllHistoryConfirm: '确定要清空所有翻译历史记录吗？',
    translationCopied: '翻译结果已复制',
    warning: '警告',
    confirm: '确定'
}
export default zh
